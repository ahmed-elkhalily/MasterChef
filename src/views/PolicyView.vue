...
const data = ref(settingStore.policy[route.params.id|| 1].page_translations.find(element => element.lang === locale.value) )
watch(route, ()=>{
    data.value =settingStore.policy[route.params.id|| 1].page_translations.find(element => element.lang === locale.value)
})
